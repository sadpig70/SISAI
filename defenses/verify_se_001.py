#!/usr/bin/env python3
"""Evidence-based verification for SE-001 (defensive detection accuracy).

Runs the SE-001 detector over a labeled benign/malicious suite and measures
...
from defenses.detectors.social_eng_detector import load_rule, scan  # noqa: E402

_SAMPLES = os.path.join(_HERE, "tests", "social_eng_samples.jsonl")
RECALL_MIN = 1.0
PRECISION_MIN = 0.85
