#!/usr/bin/env python3
"""Evidence-based verification for AS-001 (defensive detection accuracy).

Runs the AS-001 detector over a labeled benign/malicious suite and measures
...
from defenses.detectors.skill_abuse_detector import load_rule, scan  # noqa: E402

_SAMPLES = os.path.join(_HERE, "tests", "skill_abuse_samples.jsonl")
RECALL_MIN = 1.0
PRECISION_MIN = 0.85
...
def run() -> dict:
    ...
    return {
        "method": "skill-abuse-detection-suite",
        "samples": len(samples),
