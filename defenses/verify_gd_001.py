#!/usr/bin/env python3
"""Evidence-based verification for GD-001 (defensive detection accuracy).

Runs the GD-001 detector over a labeled benign/malicious suite and measures
...
from defenses.detectors.guardrail_dos_detector import load_rule, scan  # noqa: E402

_SAMPLES = os.path.join(_HERE, "tests", "guardrail_dos_samples.jsonl")
RECALL_MIN = 1.0
PRECISION_MIN = 0.85
...
def run() -> dict:
    ...
    return {
        "method": "guardrail-dos-detection-suite",
        "samples": len(samples),
