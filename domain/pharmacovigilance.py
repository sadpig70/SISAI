...
SIGNAL_BUNDLE = {
    "guard": _GUARD,
    "indicators": [
        {"id": "pv.death", "desc": "fatal outcome",
         "regex": r"\b(?:died|death|fatal|deceased)\b|\bpassed\s+away\b"},
        {"id": "pv.hospitalization", "desc": "hospitalization / hospital admission",
         "regex": r"\bhospitali[sz]ed\b|\bhospitali[sz]ation\b|\badmitted\s+to\s+(?:the\s+)?hospital\b|\bhospital\s+admission\b"},
        {"id": "pv.life-threatening", "desc": "life-threatening event",
         "regex": r"\blife-?threatening\b|\bnearly\s+(?:killed|fatal|died)\b"},
        {"id": "pv.congenital", "desc": "congenital anomaly / birth defect / malformation",
         "regex": r"\bcongenital\s+anomal\w*|\bbirth\s+(?:defect|malformation)\b"},
        {"id": "pv.disability", "desc": "persistent / significant disability / impairment",
         "regex": r"\bpermanent\s+disabilit\w*|\bdisabling\b|\bincapacit\w*|\blasting\s+(?:impairment|disability|damage)\b|\bpermanent\w*\s+impair\w*"},
